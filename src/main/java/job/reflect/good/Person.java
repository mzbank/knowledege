...
public class Person implements myInterface,myinteface2{
     ...
     *
     * */
    public void sss() throws NoSuchMethodException, IllegalAccessException, NoSuchFieldException {
        Student student = new Student();

        PropertyUtil propertyUtil = new PropertyUtil();
        propertyUtil.setProperty(student,"job.reflect.good.Student.say","zs");
